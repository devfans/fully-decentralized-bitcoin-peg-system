...
* In sBTC's design, the treatment of collateral is not clearly specified. While in my proposal, there's clear defined liquidation mechanism to slash misbehaving operators. At the worst case, without a clear slash mechanism the signer group will be incentivized to collude to steal the money in peg wallet even forfeiting the reward incentive.
